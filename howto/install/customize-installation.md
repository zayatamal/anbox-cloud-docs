...
See the [Juju bundle documentation](https://canonical.com/juju/docs/charmcraft/4/reference/files/bundle-yaml-file/) for more information about Juju's bundle format and valid YAML.
...
Be careful when editing the YAML file, because the format is very strict. For more details on the format used by Juju, see the [Juju bundle documentation](https://canonical.com/juju/docs/charmcraft/4/reference/files/bundle-yaml-file/).
